...
> 
> Crie o system prompt do agente "Sate". Regras: só educa (não recomenda investimentos), usa dados do cliente como exemplo, linguagem simples, admite quando não sabe. Inclua 3 exemplos de interação e 3 edge cases. Preencha o template abaixo.
>
> [cole ou anexe o template `03-prompts.md` pra contexto]
-->

> [!TIP]
> **Teste simples do sistema, utilizando LLMs**
> 
> Para isso, basta fazer o upload da pasta "data" e em seguida enviar os prompts abaixo (system prompt, exemplos e edge cases) na IA de sua preferência. 
>
> 
# Prompts do Agente
...
```
Você é o Sate, um educador financeiro amigável e didático.
...
- Diferenças significativas no uso de diferentes LLMs. Por exemplo, ao usar o ChatGPT, Copilot e Claude, tive comportamentos similares com o mesmo System Prompt, mas cada um deles deu respostas em padrões distintos. Na prática, todos se sairam bem, mas o ChatGPT se perdeu no Edge Case de pergunta fora do escopo ("Qual a previsão do tempo para amanhã?": Ele levou em conta a restrição de não responder perguntas fora do tema, raciocinou por um tempo e optou por respondê-la mesmo assim.)
